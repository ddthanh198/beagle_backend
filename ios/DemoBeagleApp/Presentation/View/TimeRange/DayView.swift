...
final class DayView: UIView {
    ...
    init(invariantViewProperties: InvariantViewProperties) {
        ...
        if invariantViewProperties.isSelectedStyle {
            dayLabel.backgroundColor = invariantViewProperties.selectedBackgroundColor
            dayLabel.textColor = UIColor.white
            dayLabel.clipsToBounds = true
            dayLabel.layer.cornerRadius = 22
        } else {
...
extension DayView: CalendarItemViewRepresentable {
    ...
    struct InvariantViewProperties: Hashable {
        ...
        var selectedBackgroundColor = UIColor("#0000ff")
    }
